...
#   INSTALL_PREFIX=/target/path/wires-wine-11.13 ./build.sh
...
INSTALL_PREFIX="${INSTALL_PREFIX:-/opt/wires-wine-11.13}"
...
$ENGINE run --rm \
    ...
    -e "WIRES_DIST_VERSION=${WIRES_DIST_VERSION:-${ABLETON_DIST_VERSION:-}}" \
    -e "WIRES_BUILD_KIND=${WIRES_BUILD_KIND:-${ABLETON_BUILD_KIND:-}}" \
    "$IMAGE" \
