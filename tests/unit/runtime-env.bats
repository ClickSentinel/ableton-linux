...
# Three resolution tests are held back with the version store: the legacy-path
# fallback, the container winning over it, and the container winning once it
# exists. ableton_wine_root resolves one
