...
| # | Test | Guards |
| --- | --- | --- |
| 1 | VERSION has a matching CHANGELOG entry at the top | commit e221cc4 — the changelog lands before the VERSION bump, so this cannot gate a PR |
| 2 | VERSION has a committed BUILD-INFO, as release.yml's draft job demands | — |
| 3 | the BUILD-INFO for this VERSION names the patch count the series holds | — |
| 4 | README points at the stable installer asset release.sh actually uploads | — |
